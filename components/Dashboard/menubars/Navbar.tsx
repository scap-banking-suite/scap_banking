...
export const Navbar = (props: Props) => {
  return (
    <nav className="bg-white border-b border-b-borderblack h-[68px] flex items-center justify-between py-4 px-7">
      {/* <p>bjv</p> */}
      <div className="flex gap-5 items-center">
        ...
        <div className="flex items-center gap-4">
          ...
          <span className="text-[#1C1C1C33] text-sm font-normal">/</span>
          <p className="text-[#1C1C1C] text-sm font-normal">Overview</p>
        </div>
      </div>
      <div className="flex gap-5 items-center">
